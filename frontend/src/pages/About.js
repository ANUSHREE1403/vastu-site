        ...
        <div className="space-y-10">
          ...
          >
            ...
            <ul className="grid md:grid-cols-2 gap-3 text-gray-700 dark:text-gray-300">
              <li>• {isHindi ? 'बिना किसी संरचनात्मक बदलाव के व्यक्तिगत समाधान' : 'Personalized Vastu solutions with no structural changes'}</li>
              <li>• {isHindi ? '9 से 180 दिनों में मापनीय परिणाम' : 'Measurable results within 9 to 180 days'}</li>
              <li>• {isHindi ? 'शिक्षा और जागरूकता' : 'Educating people about the impact of their spaces'}</li>
              <li>• {isHindi ? 'प्रमाणित विशेषज्ञों द्वारा मार्गदर्शन' : 'Guidance by certified Vastu specialists'}</li>
              <li>• {isHindi ? 'स्वास्थ्य, धन, संबंध और समग्र कल्याण में सुधार' : 'Lasting improvements in health, wealth, relationships, and well-being'}</li>
              <li>• {isHindi ? 'प्रामाणिक ज्ञान को आधुनिक ज़रूरतों के अनुकूल बनाना' : 'Preserving authentic wisdom while adapting to modern needs'}</li>
            </ul>
          </motion.section>
          ...
          >
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              <li>• {isHindi ? 'अकादमी ऑफ वैदिक विद्या से प्रमाणित विशेषज्ञ' : 'Certified by the Academy of Vedic Vidya'}</li>
              <li>• {isHindi ? 'सैकड़ों संतुष्ट ग्राहकों का भरोसा' : 'Proven track record with hundreds of satisfied clients'}</li>
              <li>• {isHindi ? 'व्यावहारिक और किफायती समाधान' : 'Practical, affordable, and non-disruptive solutions'}</li>
              <li>• {isHindi ? 'समग्र दृष्टिकोण' : 'Holistic approach that creates comprehensive harmony'}</li>
              <li>• {isHindi ? 'करुणामय और गोपनीय मार्गदर्शन' : 'Compassionate guidance with confidentiality'}</li>
            </ul>
          </motion.section>
        </div>
      </div>
