...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-16">
      <SEO title={"Vastu shakti by Sumedha chandra About page"} description={"Transform your life with Vastu Shakti - Ancient Vastu Shastra wisdom for modern living. Book free consultation and create harmonious spaces for prosperity and happiness."} />
